...
class GildedRoseTest(unittest.TestCase):
    ...
    def test_normal_udp_quality_with_q_gt_0(self):
        ...
        self.assertEqual(normal_item.item.quality, 19,
    ...
    def test_normal_upd_quality_with_q_eq_0(self):
        ...
        normal_item.update_quality()
        self.assertEqual(normal_item.item.quality, 0,
    ...
    def test_normal_upd_quality_with_s_lt_0(self):
        ...
        normal_item.update_quality()
        self.assertEqual(normal_item.item.quality, 2,
    ...
    def test_normal_upd_sell_in(self):
        ...
        self.assertEqual(normal_item.item.sell_in, 9, "For Normal Item, update sell_in must decrease sell_in by one")
    ...
    def test_sulfuras_udp_quality_with_s_gt_0(self):
        ...
        self.assertEqual(sulfuras_item.item.sell_in, 1, "For Sulfuras Item, sell_in must not change")
        self.assertEqual(sulfuras_item.item.quality, 80, "For Sulfuras Item, quality must be equal to 80")
    ...
    def test_sulfuras_udp_quality_with_s_eq_0(self):
        ...
        sulfuras_item.update_sell_in()
        sulfuras_item.update_quality()
        self.assertEqual(sulfuras_item.item.sell_in, 0, "For Sulfuras Item, sell_in must not change")
        self.assertEqual(sulfuras_item.item.quality, 80, "For Sulfuras Item, quality must be equal to 80")
    ...
    def test_conjured_udp_quality_with_q_gt_0(self):
        ...
        self.assertEqual(conjured_item.item.quality, 18,
    ...
    def test_conjured_upd_quality_with_q_eq_0(self):
        ...
        conjured_item.update_quality()
        self.assertEqual(conjured_item.item.quality, 0,
    ...
    def test_conjured_upd_quality_with_s_lt_0(self):
        ...
        conjured_item.update_quality()
        self.assertEqual(conjured_item.item.quality, 2,
    ...
    def test_conjured_upd_sell_in(self):
        ...
        self.assertEqual(conjured_item.item.sell_in, 9, "For Conjured Item, "
    ...
    def test_aged_brie_udp_quality_with_qs_gt_0(self):
        ...
        self.assertEqual(aged_brie_item.item.quality, 1,
    ...
    def test_aged_brie_udp_quality_with_s_lt_0(self):
        ...
        aged_brie_item.update_quality()
        self.assertEqual(aged_brie_item.item.quality, 2,
    ...
    def test_back_stage_udp_quality_with_s_gt_10(self):
        ...
        self.assertEqual(back_stage_item.item.quality, 21,
    ...
    def test_back_stage_udp_quality_with_s_lt_10_gt_5(self):
        ...
        back_stage_item.update_quality()
        self.assertEqual(back_stage_item.item.quality, 22,
    ...
    def test_back_stage_udp_quality_with_s_lt_5_gt_0(self):
        ...
        back_stage_item.update_quality()
        self.assertEqual(back_stage_item.item.quality, 23,
    ...
    def test_back_stage_udp_quality_with_s_lt_5_gt_0_q_boarder(self):
        ...
        back_stage_item.update_quality()
        self.assertEqual(back_stage_item.item.quality, AbstractItem.max_quality,
